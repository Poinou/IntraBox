...
($isAdmin, $user_group, $user_size_file_limit, $user_size_space_limit) = recuperation_donnees_session_user($user);
...
sub recuperation_donnees_session_user {
	...
	return ($isAdmin, $user_group, $user_size_file_limit, $user_size_space_limit);
}
